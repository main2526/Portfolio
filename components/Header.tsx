...
export default function Header() {
  ...
  return (
    <header className="relative text-center py-12 px-4 sm:py-16 sm:px-12 bg-slate-800 dark:bg-slate-900 text-white dark:text-yellow-400">
      ...
      {/* Contenedor de imagen y mensaje */}
      <div className="relative flex flex-col items-center mb-3">
        {/* Contenedor relativo para la imagen de perfil */}
        <div className="relative flex flex-col items-center">
          ...
          <div className="relative mt-2 sm:absolute sm:top-4 sm:-right-22 sm:translate-x-[10%] sm:mt-0">
            <span className="relative inline-flex overflow-hidden rounded-full p-[1px]">
              ...
              <div className="inline-flex items-center justify-center px-3 py-1 text-sm bg-gray-800 rounded-full cursor-pointer dark:bg-gray-800 dark:text-white/80 backdrop-blur-3xl whitespace-nowrap">
                {tAva("ava")}
              </div>
            </span>
          </div>
